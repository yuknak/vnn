...
jQuery(document).ready(function() {
    ...
    */
    $('.top-content').backstretch("assets2/img/backgrounds/1.jpg");
    $('.how-it-works-container').backstretch("assets2/img/backgrounds/1.jpg");
    $('.call-to-action-container').backstretch("assets2/img/backgrounds/1.jpg");
    $('.latest-tweets-container').backstretch("assets2/img/backgrounds/1.jpg");
    $('.contact-container').backstretch("assets2/img/backgrounds/2.jpg");
